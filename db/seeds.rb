...
Toilet.create(
        ...
        :description => "changing bench:  height adjustable, free standing
...
Toilet.create(
        ...
        :description => "changing bench:  Mistral Hydraulic height adjustable change table 200kgs/32st weigh capacity
 hoist:  Ceiling track",
...
Toilet.create(
        ...
        :description => "changing bench:  Heigh adjustable, free standing, adult sized
 hoist:  Ceiling track",
        :toiletlocation =>'Centrally placed toilet with room either side for the carers',
        :whocanuse =>'Anyone in the area who needs to',
        :long => '-1.7369347',
...
Toilet.create(
        ...
        :whocanuse =>'Centrally placed toilet with room either side for carers',
        :long => '0.3376220',
        :lat => '53.1403340',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
        ...
        :description => " hoist:  Height adjustable and adult sized",
...
Toilet.create(
        ...
        :description => "changing bench:  Height adjustable, wall mounted, adult sized
 hoist:  Ceiling track",
...
Toilet.create(
 ...
 hoist:  Ceiling track hoist â€“ XY Hoist",
        :toiletlocation =>' Centrally placed toilet with room either side for the carers',
        :whocanuse =>'Anyone in the area who would like to use it. Theyâ€™ll need to become a member the first time they use it (but it should only take few minutes to register).',
        :long => '-1.5885170',
        :lat => '54.9200700',
        :hoist => true,
        :changingbench => true
...
The door is open when not in use',
 ...
 hoist:  Chiltern ceiling track hoist",
        ...
        :whocanuse =>'All visitors and staff',
        :long => '-0.0777414',
        :lat => '51.5031561',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
        ...
        :description => "changing bench:  10.30 - 4pm weekdays. After these hours and at weekends (24 hours per day) access can be gained by use of an entry key (see above)
...
Toilet.create(
        ...
        :description => "changing bench:  Height adjustable and adult sized
 hoist:  Ceiling track",
        :toiletlocation =>'Centrally placed toilet with room either side for the carers',
...
Toilet.create(
        ...
        :description => "changing bench:  Free standing, adult sized
 ",
        :toiletlocation =>' Ceiling track',
        :whocanuse =>'Corner',
        :long => '-1.7152265',
...
Toilet.create(
        ...
        :description => "changing bench:  Height adjustable, free standing, adult sized, wall mounted
 hoist:  Ceiling track hoist â€“ Chiltern Invadex Wispa 300 XY Hoist",
        :toiletlocation =>' Corner toilet',
        :whocanuse =>'Anyone in the area who would like to use it. Theyâ€™ll need to become a member the first time they use it (but it should only take few minutes to register).',
        :long => '-1.6072685',
...
Toilet.create(
        ...
        :description => "changing bench:  Free standing height adjustable.
...
Toilet.create(
        ...
        :venuetype =>' Leisure Centre',
        :howtoaccess =>'Key available at reception',
        :description => "changing bench:  Height-adjustable, adult sized, free-standing
 hoist:  H-frame ceiling track hoist",
        :toiletlocation =>'Centrally placed toilet with room either side for the carers',
        :whocanuse =>'Anyone in the area who needs to use it',
        :long => '-1.1902296',
        :lat => '53.0120514',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
 ...
 hoist:  Ceiling track â€“ Guldmann 250 Kg max (550lbs)",
        :toiletlocation =>'Centrally placed toilet with room either side for the carers',
        :whocanuse =>'Anyone in the area who needs to. Please phone ahead if possible on T: 0845 2412 540',
        :long => '-2.7379630',
        :lat => '52.2240750',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
        ...
        :description => "changing bench:  Pressalit - height adjustable, wall-mounted bench.
...
Toilet.create(
 ...
 hoist: Ceiling track",
        ...
        :whocanuse =>'Toilet is operated on a free of charge membership scheme from the Red Mall Customer Services desk. The toilet also has a camera controlled entrance, where the membership number is required for entrance.',
        :long => '-1.6018252',
        :lat => '54.9593729',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
        ...
        :description => " hoist:  Height adjustable, wall mounted, adult sized",
        :toiletlocation =>' Ceiling track',
        :whocanuse =>'Centrally placed toilet with room either side for the carers',
        :long => '-2.5325270',
        :lat => '53.0646942',
...
Toilet.create(
        ...
        :description => "changing bench:  Height adjustable, adult sized
 hoist:  Mobile Hoist - Freeway Hydraulic 175<strong>&#160;",
        :toiletlocation =>' Centrally placed toilet with room either side for the carers',
        :whocanuse =>'Anyone using the stadium',
        :long => '-2.6913300',
        :lat => '53.7687500',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
 ...
 hoist:  Ceiling track - Ario hoist",
        :toiletlocation =>'Peninsular toilet (Clos o Mat Lima lift)',
        :whocanuse =>'Changing Places toilet is on Floor B and is available to anyone in the area who needs to use it.',
        :long => '-1.4924300',
        :lat => '53.3775600',
        :hoist => true,
        :changingbench => true
...
Toilet.create(
        ...
        :howtoaccess =>'With a radar key',
        :description => "changing bench:  Height adjustable, wall mounted, adult sized changing bench
